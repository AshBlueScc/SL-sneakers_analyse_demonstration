<template>
  <div>
    ...
    <el-row>
      <el-col :span="5" v-for="(singeCategory, index) in tableCategory" :key="index">
        <el-card :body-style="{ padding: '1.5px', margin: '6.5px' }" shadow="hover" style="margin: 6.5px; cursor:pointer" @click.native="curClick(ss)" class="element-card">   
